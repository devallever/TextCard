...
data class ColorData(
    ...
    companion object {
        ...
        val MEDIA_BLUE_LIME_GRADIENT = ColorData("Blue lime gradient", mutableListOf("#a0e59b", "#7fc3ed"))
        val MEDIA_PINK_BLUE_GRADIENT = ColorData("Pink blue gradient", mutableListOf("#39befa", "#d2c9d9"))
        val MEDIA_BLUE_VIOLET_GRADIENT = ColorData("Blue violet gradient", mutableListOf("#b3bffd", "#8b8cf9"))
        val MEDIA_SKY_ORANGE_GRADIENT = ColorData("Sky orange gradient", mutableListOf("#e2d4c5", "#9fcbfd"))
        val MEDIA_PURPLE_YELLOW_GRADIENT = ColorData("Purple yellow gradient", mutableListOf("#f3e7d7", "#dabdff"))
        val MEDIA_PINK_GRADIENT = ColorData("Pink gradient", mutableListOf("#fdbdbd", "#fa8280"))
        val MEDIA_PINK_RED_GRADIENT = ColorData("Pink red gradient", mutableListOf("#f67286", "#f471b5"))
        val MEDIA_RED_ORANGE_GRADIENT = ColorData("Red orange gradient", mutableListOf("#fdab99", "#fdc283"))
        val MEDIA_LIGHT_DARK_ORANGE_GRADIENT =  ColorData("Dark orange gradient", mutableListOf("#fde589", "#fd9641"))
        val MEDIA_LIGHT_BLUE_PURPLE_GRADIENT =  ColorData("Light blue purple gradient", mutableListOf("#c4d8fd", "#d3b4fd"))
        val MEDIA_YELLOW_ORANGE_GRADIENT =  ColorData("Yellow orange gradient", mutableListOf("#FDF19C", "#FEDC63"))
        ...
        val MEDIA_DARK_SKY_GRADIENT = ColorData("Dark sky gradient", mutableListOf("#0c405e", "#071420"))
        val MEDIA_DARK_CYAN_GRADIENT = ColorData("Dark cyan gradient", mutableListOf("#0f3346", "#071320"))
        val MEDIA_DARK_VIOLET_GRADIENT =ColorData("Dark violet gradient", mutableListOf("#40197d", "#150a25"))
        val MEDIA_DARK_FUSHSIA_GRADIENT = ColorData("Dark fushsia gradient", mutableListOf("#591868", "#1f0d3d"))
        val MEDIA_DARK_ROSE_GRADIENT = ColorData("Dark rose gradient", mutableListOf("#70102c", "#1d080c"))
        val MEDIA_DARK_EMERALD_GRADIENT = ColorData("Dark emerald gradient", mutableListOf("#0d4224", "#03160c"))
        val MEDIA_DARK_GRAY_GRADIENT = ColorData("Dark gray gradient", mutableListOf("#1a2432", "#0d1221"))
        val MEDIA_DARK_SLATE_GRADIENT = ColorData("Dark slate gradient", mutableListOf("#192437", "#0d1025"))
        val MEDIA_DARK_NEUTRAL_GRADIENT = ColorData("Dark neutral gradient", mutableListOf("#343434", "#0f0f0f"))
        val MEDIA_DARK_STONE_GRADIENT = ColorData("Dark stone gradient", mutableListOf("#44423d", "#191412"))
        ...
        val SOLID_DARK_LIGHT_WARM_GRAY = ColorData("Light warm gray", mutableListOf("#262626", "#262626"))
        val SOLID_DARK_LIGHT_COLD_GRAY = ColorData("Light cold gray", mutableListOf("#1e293b", "#1e293b"))
